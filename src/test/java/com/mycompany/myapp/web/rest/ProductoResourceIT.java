...
class ProductoResourceIT {
    ...
    void putExistingProducto() throws Exception {
        ...
        updatedProducto.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).imagen(UPDATED_IMAGEN).ingredientes(UPDATED_INGREDIENTES);
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).imagen(UPDATED_IMAGEN).ingredientes(UPDATED_INGREDIENTES);
